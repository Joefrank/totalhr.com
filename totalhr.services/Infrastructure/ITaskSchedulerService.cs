...
namespace totalhr.services.Infrastructure
{
    public interface ITaskSchedulerService
    {
        ...
        bool RecordTask(int id, string name, string description, int departmentId, bool needsApproval, int assignedBy, int assignedTo, DateTime? completeBy, Audit audit);
        TRS.TaskScheduler GetById(int id);
    }
}
