...
CREATE proc [dbo].[BuildCalEventReminderRecipientList]
...
begin
	...
	begin
		...
		select u.id, u.email, u.firstname + ' ' + u.surname, ISNULL(u.Mobile, u.Phone),  0, null, @recipientListId
		from [User]  u
	...
	begin
		...
		insert into Recipient
		select distinct u.id, u.email, u.firstname + ' ' + u.surname, ISNULL(u.Mobile, u.Phone),  0, null, @recipientListId
		from [User]  u
...
End
 ...
 select isnull(@recipientListId, 0) as RecipientListId
