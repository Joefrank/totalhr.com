...
(function (angular) {
                ...
                fields: {
                    add: function (objectTemplate, categories, templateUrl, propertiesTemplateUrl) {
                        ...
                        if (!objectTemplate || !objectTemplate.type || !categories || !categories.length) {
                            throw new Error('Veuillez sélectionner un modèle et une category');
                        }
                ...
                validation: {
                    message: function (typeOrObject, message) {
                        ...
                        if (angular.isString(typeOrObject)) {
                            ...
                            if (!message) {
                                throw new Error('Aucun message spécifié pour ' + typeOrObject);
                            }
    ...
    fg.config(["fgConfigProvider", "FgField", function (fgConfigProvider, FgField) {
        ...
        fgConfigProvider.validation.message({
            required: 'Ce champ est obligatoire. Veuillez saisir une valeur.',
            minlength: 'La valeur doit avoir au moins {{ field.schema && (" of " + field.schema.validation.minlength + " caractères" || "")}}.',
            maxlength: 'La valeur depasse le maximum autorisé {{ field.schema && (" de " + field.schema.validation.maxlength + " caractères" || "")}}.',
            pattern: 'La valeur "{{ field.state.$viewValue }}" ne correspond pas au format réquis.',
            email: 'La valeur "{{ field.state.$viewValue }}" n\'est pas une adresse électronique valide.',
            unique: 'La valeur "{{ field.state.$viewValue }}" est deja prise.',
            number: 'La valeur "{{ field.state.$viewValue }}" n\'est pas un nombre.',
            min: 'La valeur {{ field.schema && ("doit etre au minimum " + field.schema.validation.min) || field.state.$viewValue + " est tres petite." }}',
            max: 'La valeur {{ field.schema && ("doit etre moin de " + field.schema.validation.max) || field.state.$viewValue + " est tres grande." }}'
        });
    ...
    fg.directive('fgEditValidationMessage', ["fgEditValidationMessageLinkFn", function (fgEditValidationMessageLinkFn) {
        ...
        var DEFAULT_TOOLTIP = "Saisissez un message d'erreur qui s'affichera si jamais la validation échoue. Si ce champ est vide un message par défaut sera utilisé.";
